...
@pytest.mark.parametrize("mi_simple", ["renders/tests/mi_simple.png"])
def test_same_renders(resource_resolver, mi_simple):
    r = cv2.imread(resource_resolver.get_absolute_resource_path(mi_simple))
    r2 = r
    err, v, diff = mae(r, r2)
